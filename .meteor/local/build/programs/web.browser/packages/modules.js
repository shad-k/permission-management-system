...
install("standard-minifier-css");                                                                                      // 65
install("standard-minifier-js");                                                                                       // 66
install("shell-server");                                                                                               // 67
install("autopublish");                                                                                                // 68
install("fourseven:scss");                                                                                             // 69
install("jquery", "meteor/jquery/main.js");                                                                            // 70
install("materialize:materialize");                                                                                    // 71
install("ddp-rate-limiter");                                                                                           // 72
install("localstorage");                                                                                               // 73
install("callback-hook");                                                                                              // 74
...
install("zodiase:material-design-icons-fonts");                                                                        // 83
install("alanning:roles");                                                                                             // 84
install("webapp");                                                                                                     // 85
install("livedata");                                                                                                   // 86
install("hot-code-push");                                                                                              // 87
install("spacebars");                                                                                                  // 88
install("templating-compiler");                                                                                        // 89
install("templating-runtime");                                                                                         // 90
install("templating");                                                                                                 // 91
install("launch-screen");                                                                                              // 92
install("ui");                                                                                                         // 93
install("autoupdate");                                                                                                 // 94
install("service-configuration");                                                                                      // 95
                                                                                                                       // 96
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
